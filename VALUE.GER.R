...
test <- subsetGrid(localPRED, years = 1995)
...
DBN <- build.downscalingBN(local, localPRED , mode = 1, bnlearning.algorithm = hc.local2, already.categorical = TRUE,
                           parallelize = FALSE, cluster.type =  n.cores = 7,
