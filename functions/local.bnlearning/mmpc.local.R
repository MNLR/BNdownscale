...
mmpc.local <- function(x, positions, distance, norm = "2", exceptions = NULL, plotrestrictions = FALSE, 
  ...
  return( mmpc(x = x, cluster = cluster, whitelist = whitelist, blacklist = blacklist, test = test,
