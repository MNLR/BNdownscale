...
si.hiton.pc.local <- function(x, positions, distance, norm = "2", exceptions = NULL, plotrestrictions = FALSE, 
  ...
  return( si.hiton.pc(x = x, cluster = cluster, whitelist = whitelist, blacklist = blacklist, test = test,
